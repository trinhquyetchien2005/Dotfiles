...
keymap.set("n", "<Leader>d", '"_dd', opts)
...
--duplicate line
keymap.set("n", "<Leader>du", "yyp", opts)
...
keymap.set('n', '<Leader>gn', function() vim.cmd('lua require"nvim-treesitter.incremental_selection".init_selection()') end, opts)
keymap.set('n', '<Leader>gr', function() vim.cmd('lua require"nvim-treesitter.incremental_selection".node_incremental()') end, opts)
keymap.set('n', '<Leader>gs', function() vim.cmd('lua require"nvim-treesitter.incremental_selection".scope_incremental()') end, opts)
keymap.set('n', '<Leader>gm', function() vim.cmd('lua require"nvim-treesitter.incremental_selection".node_decremental()') end, opts)
...
vim.keymap.set("n", "<Leader>bd", smart_close_buffer, { noremap = true, silent = true })
